...
create table employee_db.EMPLOYEE_2
(
...
insert into employee_db.EMPLOYEE_2(EMPNO, ENAME, MGR, HIREDATE, SAL, DEPTNAME)
...
--Table Name: employee_db.INCENTIVES

create table employee_db.INCENTIVES
(
  EMPID            INTEGER,
  INCENTIVE_DATE   DATE,
  INCENTIVE_AMOUNT double(18,2)
)
insert into employee_db.INCENTIVES (EMPID, INCENTIVE_DATE, INCENTIVE_AMOUNT)
